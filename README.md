...
local function createLoadingScreen()
    ...
    -- Título "Lcc hub" com efeito brilhante
...
local Window = Libary:MakeWindow({
    Title = "Lcc Hub | Brookhaven RP ",
    SubTitle = "by Lcc 027",
    LoadText = "Loading Lcc Hub",
    Flags = "Lcc hub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://111216379675169", BackgroundTransparency = 0 },
...
InfoTab:AddDiscordInvite({
    Name = "Lcc Hub",
    Description = "",
    Logo = "rbxassetid://111216379675169",
    Invite = "https://discord.gg/EfcvSadH4",
})
